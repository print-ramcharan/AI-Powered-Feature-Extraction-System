...
- **Data Uploaded to Kaggle:** Ram successfully uploaded the tiled datasets to Kaggle for immediate team use.
  - **Kaggle Link:** `http://kaggle.com/datasets/pramcharanteja/chhattisgarh-vol3-vol24` (Example format, use PRamcharanTeja profile for all files)
  - Dataset 1: `punjab_baga_vol1` (1435 tiles)
  - Dataset 2: `punjab_fattu_bhila_vol1` (1120 tiles)
  - Dataset 3: `Chhattisgarh_vol1`, `Chhattisgarh_vol2`, `Chhattisgarh_vol3-vol24`
